...
The Adyen Google Wallet Provisioning SDK has a transitive dependency on the Google Push Provisioning API (version 18.8.0). 
...
* **Google Tap and Pay dependency not found** - make sure you have the `com.google.android.gms:play-services-tapandpay:18.8.0` dependency correctly hosted using maven local.
