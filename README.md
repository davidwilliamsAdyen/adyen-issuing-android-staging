...
```kotlin
implementation("com.adyen.issuing:provisioning:0.2.1")
```
...
* [Full Documentation](https://adyen.github.io/adyen-google-pay-provisioning-android/0.2.1/Api/)
* [SDK Reference Adyen Google Pay Provisioning](https://adyen.github.io/adyen-google-pay-provisioning-android/0.2.1/AdyenGoogleWalletProvisioning//)
